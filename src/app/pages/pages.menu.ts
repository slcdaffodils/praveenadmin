export const PAGES_MENU = [
  {
    ...
    children: [
      {
        path: 'appsum',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'App Summary', // menu title
            icon: 'ion-laptop', // menu icon
      ...
      {
        path: 'networkflow',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'Networkflow Report', // menu title
            icon: 'ion-ios-pulse-strong', // menu icon
            pathMatch: 'prefix', // use it if item children not displayed in menu
            selected: false,
            expanded: false,
            order: 0
      ...
      {
        path: 'networkmetrics',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'Network Matrics', // menu title
            icon: 'ion-wifi', // menu icon
            pathMatch: 'prefix', // use it if item children not displayed in menu
            selected: false,
            expanded: false,
            order: 0
      ...
      {
        path: 'hostsum',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'Host Summary', // menu title
      ...
      {
        path: 'jvmsum',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'JVM Summary', // menu title
            icon: 'ion-shuffle', // menu icon
            pathMatch: 'prefix', // use it if item children not displayed in menu
            selected: false,
            expanded: false,
            order: 0
      ...
      {
        path: 'requestbdown',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'Request Break Down', // menu title
            icon: 'ion-fork-repo', // menu icon
            pathMatch: 'prefix', // use it if item children not displayed in menu
            selected: false,
            expanded: false,
            order: 0
      ...
      {
        path: 'databasematrics',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'Database Matrics', // menu title
            icon: 'ion-soup-can', // menu icon
            pathMatch: 'prefix', // use it if item children not displayed in menu
            selected: false,
            expanded: false,
            order: 0
      ...
      {
        path: 'uristat',  // path for our page
        data: { // custom menu declaration
          menu: {
            title: 'URI Stats', // menu title
            icon: 'ion-ios-cloudy', // menu icon
            pathMatch: 'prefix', // use it if item children not displayed in menu
            selected: false,
            expanded: false,
            order: 0
